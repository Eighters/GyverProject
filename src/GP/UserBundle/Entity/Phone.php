 ...
 * @ORM\Entity(repositoryClass="GP\UserBundle\Entity\PhoneRepository")
 */
class Phone
{
    /**
     ...
     * @var integer
     *
     * @ORM\ManyToOne(targetEntity="GP\UserBundle\Entity\User", inversedBy="phoneList", cascade = {"persist"})
     */
    private $user;
