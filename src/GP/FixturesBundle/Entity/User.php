 ...
 *
 * @ORM\Table(name="user")
 * @ORM\Entity(repositoryClass="GP\FixturesBundle\Entity\UserRepository")
 */
class User extends BaseUser
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="GP\FixturesBundle\Entity\Phone", mappedBy="user", cascade={"remove"})
     */
    private $phoneList;

    /**
     * @ORM\OneToMany(targetEntity="GP\FixturesBundle\Entity\Email", mappedBy="user", cascade={"remove"})
     */
    protected $emailList;
