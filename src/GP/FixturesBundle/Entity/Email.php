 ...
 * @ORM\Entity(repositoryClass="GP\FixturesBundle\Entity\EmailRepository")
 */
class Email
{
    /**
     ...
     * @var integer
     *
     * @ORM\ManyToOne(targetEntity="GP\FixturesBundle\Entity\User", inversedBy="emailList", cascade = {"persist"})
     */
    private $user;
